    ...
    public static class TooterManager
    {
        ...
        public static bool OnDemonDialogueDoDialoguePostFix(object[] __args, DemonDialogue __instance)
        {
            ...
            switch (_currentDialogueState)
            {
                ...
                case 177:
                    ...
                    break;
                case 178:
                    Plugin.Instance.StartCoroutine(FadeOutScene(__instance, 179, 8.5f));
                    break;
                case 180:
        ...
        public static Dictionary<int, DialogueData> GetDialogueChapter3() => new Dictionary<int, DialogueData>()
        {
            ...
            {3205059, // Transition to 3204060
                new DialogueData()
                {
                    option2Text = $"[{_sodaColoredName} gestures towards the exit {_beezerlyColoredName}, hinting at getting some air]", //reword this for the love of god    // I gotchu bro [Thumbsup]
                    option2DialogueID = 0,
                }
            },
            {3204060,
            ...
            {3204061,
                new DialogueData()
                {
                    option2Text = $"{_beezerlyColoredName}: Tonight was a blast, we should definitely come here again sometime.",
